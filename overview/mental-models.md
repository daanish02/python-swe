...
- [Names Are References, Not Containers](#names-are-references-not-containers)
- [Mutability Changes Everything](#mutability-changes-everything)
- [Namespaces and Scope](#namespaces-and-scope)
- [Objects Have Types, Names Don't](#objects-have-types-names-dont)
- [Iteration is Protocol-Based](#iteration-is-protocol-based)
- [Exceptions are for Flow Control](#exceptions-are-for-flow-control)
- [Code is Data](#code-is-data)
- [Summary: Thinking in Python](#summary-thinking-in-python)
...
Types are attached to objects, not names. A name can refer to objects of any type.
...
This is **dynamic typing**: types are checked at runtime, not compile time.
...
The function doesn't declare types. You discover type issues when the code runs.
...
Python uses exceptions not just for errors, but as a control flow mechanism. This is embodied in **EAFP**: "Easier to Ask for Forgiveness than Permission."
