...
- [When to Use Native Extensions](#when-to-use-native-extensions)
- [Numba for JIT Compilation](#numba-for-jit-compilation)
- [Cython for Compiled Python](#cython-for-compiled-python)
